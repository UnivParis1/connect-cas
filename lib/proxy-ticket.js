...
module.exports = function(options){
    ...
    return function(req, res, next){
        ...
        request.get(url.format(options), { agentOptions : options.agentOptions }, function(err, res_, body){
            if (err || res_.statusCode !== HttpStatus.OK) return redirectToLogin(options, req, res);
